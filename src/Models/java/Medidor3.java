...
DNL
platform:/resource/smartgrid/src/Models/dnl/Medidor3.dnl
-1422531397
 Do not remove or modify this comment!  It is required for file identification! */
package Models.java;
...
public class Medidor3 extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    public Medidor3(String name) {
        this(name, null);
    }

    public Medidor3(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        Medidor3 model = new Medidor3();
        model.options = options;

        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("Medidor3 Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = Medidor3.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                Medidor3.class.getResource(".").toString());
        }
